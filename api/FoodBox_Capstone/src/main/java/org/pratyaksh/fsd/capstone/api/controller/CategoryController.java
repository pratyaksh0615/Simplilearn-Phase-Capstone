package org.pratyaksh.fsd.capstone.api.controller;
...
import org.pratyaksh.fsd.capstone.api.service.CategoryService;
...
public class CategoryController {
	...
	public void getImage(@PathVariable("id") Long id, HttpServletResponse response) throws FoodBoxServiceException {
		try {
			...
			if (image == null) {
				Resource resource = new ClassPathResource(org.pratyaksh.fsd.capstone.api.Common.DEFAULT_IMAGE);
